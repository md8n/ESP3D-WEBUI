...
const navbar = () => {
	...
	id("showPreferencesDlg").addEventListener("click", (event) =>
		showpreferencesdlg(),
	);
	...
	id("maintablink").addEventListener("click", (event) =>
		opentab(event, "maintab", "mainuitabscontent", "mainuitablinks"),
	);
	id("camtablink").addEventListener("click", (event) =>
		opentab(event, "cameratab", "mainuitabscontent", "mainuitablinks"),
	);
	id("configtablink").addEventListener("click", (event) =>
		opentab(event, "configtab", "mainuitabscontent", "mainuitablinks"),
	);
	id("settingtablink").addEventListener("click", (event) =>
		opentab(event, "settingstab", "mainuitabscontent", "mainuitablinks"),
	);
	id("tablettablink").addEventListener("click", (event) =>
		opentab(event, "tablettab", "mainuitabscontent", "mainuitablinks"),
	);

	id("password_menu").addEventListener("click", (event) => changepassworddlg());
	id("showLoginDlg").addEventListener("click", (event) => logindlg());
	id("logout_menu").addEventListener("click", (event) =>
		confirmdlg(
